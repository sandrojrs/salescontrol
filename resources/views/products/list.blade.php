                                ...
                                <div class="ps-5 pe-4 h-100">
                                    <div class="row g-0 h-100 align-content-center custom-sort">
                                        <div class="col-lg-4 d-flex flex-column mb-lg-0 pe-3 d-flex">
                                            <div class="text-muted text-small cursor-pointer sort" data-sort="name">NOME
                                            </div>
                                        </div>
                                        <div class="col-lg-2 d-flex flex-column pe-1 justify-content-center">
                                            <div class="text-muted text-small cursor-pointer sort" data-sort="email">PREÇO
                                            </div>
                                        </div>
                        ...
                        <div class="card mb-2">
                            <div class="row g-0 h-100 sh-lg-9 position-relative">
                                <a href="/Products/Detail" class="col-auto position-relative">
                                    <img src="/img/product/small/product-1.webp" alt="product"
                                    ...
                                    <div class="ps-5 pe-4 h-100">
                                        <div class="row g-0 h-100 align-content-center">
                                            ...
                                            <div
                                                ...
                                                <div class="lh-1 text-alternate">{{ $product->description }}</div>
                                            </div>
                                            <div
